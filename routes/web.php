...
//CRUD USer
Route::get('/admin/add/user/{role}',[AdminController::class,'viewAddUser']);
Route::post('/admin/add/user/{role}', [AdminController::class,'addUser']);
Route::get('/admin/{status}/profile/{role}/{id}',[AdminController::class,'viewAddProfile']);
Route::post('/admin/{status}/profile/industry/{id}',[IndustryController::class, 'CRUDIndustry'])->name('crud_industry');
// Route::get('/admin/{status}/profile/industry/{id}',[IndustryController::class, 'CRUDIndustry']);
Route::post('/admin/{status}/profile/school/{id}',[SchoolController::class, 'CRUDSchool']);
Route::post('/admin/{status}/profile/teacher/{id}',[AdminController::class, 'addProfileTeacher']);
Route::post('/admin/{status}/profile/advisor/{id}',[AdminController::class, 'AddProfileAdvisor']);
Route::post('/admin/{status}/profile/student/{id}',[AdminController::class, 'addProfileStudent']);
